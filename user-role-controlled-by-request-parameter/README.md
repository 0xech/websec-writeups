...
![Admin cookie visible in browser DevTools, set to false](01-admin-cookie-devtools.png)
...
![Failed delete request still carrying Admin=false](02-failed-delete-request.png)
